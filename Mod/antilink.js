...
module.exports = {
  ...
  run: async (client, interaction) => {
    ...
    if (!interaction.member.permissions.has(Discord.PermissionFlagsBits.Administrator)) {
        ...
        .setColor("Green")
        .setDescription(`<:right:1031945986022572092> ${interaction.user}, o sistema de antilink foi \`ativado\`.`);

        let embed_r = new Discord.EmbedBuilder()
        .setColor("Red")
        .setDescription(`<:right:1031945986022572092> ${interaction.user}, o sistema de antilink foi \`desativado\`.`);
